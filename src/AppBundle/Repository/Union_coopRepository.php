...
class Union_coopRepository extends EntityRepository
{
  ...
  public function voirContactUnion($id=1)
  {
    $quer2 = $this->_em->createQuery('SELECT u.siegeUn, u.telUn, u.eMailUn, u.heurUn, u.lnkFbUn FROM CoreBundle:Union_coop u WHERE u.id = :id');
    $quer2->setParameter('id', $id);
